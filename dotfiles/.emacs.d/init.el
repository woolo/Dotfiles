...
;; ;; Enable this will contact MELPA everytime sarting Emacs, making it extremely slow. TODO: find another way to refresh the contents.
;; ;(unless package-archive-contents (package-refresh-contents))
;; (package-initialize)

;; New Config
(require 'package) ; load a file called package in the path only if it has not been loaded
